...
Преподаватель, возрост которого составляет число в прмежутке от 24 до 40 лет. Преподаватель
...
очень давно. Однако каждый код Преподаватель лелеет надежду, что, если он даст студентам
